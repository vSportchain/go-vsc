...
// Package bind generates VSportChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-vsc Wiki page:
// https://github.com/vsportchain/go-vsc/wiki/Native-DApps:-Go-bindings-to-VSportChain-contracts
package bind
