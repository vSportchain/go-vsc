...
// Package accounts implements high level VSportChain account management.
package accounts
...
// Account represents an VSportChain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // VSportChain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain vsportchain.ChainStateReader)
