...
const (
	...
	MessageType_MessageType_VSportChainGetAddress       MessageType = 56
	MessageType_MessageType_VSportChainAddress          MessageType = 57
	MessageType_MessageType_VSportChainSignTx           MessageType = 58
	MessageType_MessageType_VSportChainTxRequest        MessageType = 59
	MessageType_MessageType_VSportChainTxAck            MessageType = 60
	...
	MessageType_MessageType_VSportChainSignMessage      MessageType = 64
	MessageType_MessageType_VSportChainVerifyMessage    MessageType = 65
	MessageType_MessageType_VSportChainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_VSportChainGetAddress",
	57:  "MessageType_VSportChainAddress",
	58:  "MessageType_VSportChainSignTx",
	59:  "MessageType_VSportChainTxRequest",
	60:  "MessageType_VSportChainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_VSportChainSignMessage",
	65:  "MessageType_VSportChainVerifyMessage",
	66:  "MessageType_VSportChainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_VSportChainGetAddress":       56,
	"MessageType_VSportChainAddress":          57,
	"MessageType_VSportChainSignTx":           58,
	"MessageType_VSportChainTxRequest":        59,
	"MessageType_VSportChainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_VSportChainSignMessage":      64,
	"MessageType_VSportChainVerifyMessage":    65,
	"MessageType_VSportChainMessageSignature": 66,
...
// *
// Request: Ask device for VSportChain address corresponding to address_n path
// @next PassphraseRequest
// @next VSportChainAddress
// @next Failure
type VSportChainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *VSportChainGetAddress) Reset()                    { *m = VSportChainGetAddress{} }
func (m *VSportChainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*VSportChainGetAddress) ProtoMessage()               {}
func (*VSportChainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *VSportChainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VSportChainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an VSportChain address derived from device private seed
// @prev VSportChainGetAddress
type VSportChainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *VSportChainAddress) Reset()                    { *m = VSportChainAddress{} }
func (m *VSportChainAddress) String() string            { return proto.CompactTextString(m) }
func (*VSportChainAddress) ProtoMessage()               {}
func (*VSportChainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *VSportChainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next VSportChainTxRequest
// @next Failure
type VSportChainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *VSportChainSignTx) Reset()                    { *m = VSportChainSignTx{} }
func (m *VSportChainSignTx) String() string            { return proto.CompactTextString(m) }
func (*VSportChainSignTx) ProtoMessage()               {}
func (*VSportChainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *VSportChainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VSportChainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *VSportChainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *VSportChainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *VSportChainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *VSportChainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *VSportChainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *VSportChainSignTx) GetDataLength() uint32 {
...
func (m *VSportChainSignTx) GetChainId() uint32 {
...
// @prev VSportChainSignTx
// @next VSportChainTxAck
type VSportChainTxRequest struct {
...
func (m *VSportChainTxRequest) Reset()                    { *m = VSportChainTxRequest{} }
func (m *VSportChainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*VSportChainTxRequest) ProtoMessage()               {}
func (*VSportChainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *VSportChainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *VSportChainTxRequest) GetSignatureV() uint32 {
...
func (m *VSportChainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *VSportChainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev VSportChainTxRequest
// @next VSportChainTxRequest
type VSportChainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *VSportChainTxAck) Reset()                    { *m = VSportChainTxAck{} }
func (m *VSportChainTxAck) String() string            { return proto.CompactTextString(m) }
func (*VSportChainTxAck) ProtoMessage()               {}
func (*VSportChainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *VSportChainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next VSportChainMessageSignature
// @next Failure
type VSportChainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *VSportChainSignMessage) Reset()                    { *m = VSportChainSignMessage{} }
func (m *VSportChainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*VSportChainSignMessage) ProtoMessage()               {}
func (*VSportChainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *VSportChainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VSportChainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type VSportChainVerifyMessage struct {
...
func (m *VSportChainVerifyMessage) Reset()                    { *m = VSportChainVerifyMessage{} }
func (m *VSportChainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*VSportChainVerifyMessage) ProtoMessage()               {}
func (*VSportChainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *VSportChainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *VSportChainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *VSportChainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev VSportChainSignMessage
type VSportChainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *VSportChainMessageSignature) Reset()                    { *m = VSportChainMessageSignature{} }
func (m *VSportChainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*VSportChainMessageSignature) ProtoMessage()               {}
func (*VSportChainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *VSportChainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *VSportChainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*VSportChainGetAddress)(nil), "VSportChainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*VSportChainAddress)(nil), "VSportChainAddress")
	...
	proto.RegisterType((*VSportChainSignTx)(nil), "VSportChainSignTx")
	proto.RegisterType((*VSportChainTxRequest)(nil), "VSportChainTxRequest")
	proto.RegisterType((*VSportChainTxAck)(nil), "VSportChainTxAck")
	proto.RegisterType((*VSportChainSignMessage)(nil), "VSportChainSignMessage")
	proto.RegisterType((*VSportChainVerifyMessage)(nil), "VSportChainVerifyMessage")
	proto.RegisterType((*VSportChainMessageSignature)(nil), "VSportChainMessageSignature")
