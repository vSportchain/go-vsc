...
// Whisper represents a dark communication interface through the VSportChain
...
// New creates a Whisper client ready to communicate through the VSportChain P2P network.
