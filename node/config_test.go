...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gvsc.ipc", false, filepath.Join(os.TempDir(), "gvsc.ipc")},
		{"data", "gvsc.ipc", false, "data/gvsc.ipc"},
		{"data", "./gvsc.ipc", false, "./gvsc.ipc"},
		{"data", "/gvsc.ipc", false, "/gvsc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gvsc.ipc", true, `\\.\pipe\gvsc.ipc`},
		{"data", "gvsc.ipc", true, `\\.\pipe\gvsc.ipc`},
		{"data", `\\.\pipe\gvsc.ipc`, true, `\\.\pipe\gvsc.ipc`},
	}
