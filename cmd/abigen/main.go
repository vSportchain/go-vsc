...
import (
	...
	"github.com/vsportchain/go-vsc/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the VSportChain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the VSportChain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the VSportChain contract Solidity source to build and bind")
