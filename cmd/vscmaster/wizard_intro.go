...
// makeWizard creates and returns a new vscmaster wizard.
...
// setting up a new or managing an existing VSportChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to vscmaster, your VSportChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new VSportChain network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and vscstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Vscmaster uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering VSportChain network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".vscmaster", w.network)
