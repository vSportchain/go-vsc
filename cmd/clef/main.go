...
import (
	...
	"github.com/vsportchain/go-vsc/signer/core"
	"github.com/vsportchain/go-vsc/signer/rules"
	"github.com/vsportchain/go-vsc/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage VSportChain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
