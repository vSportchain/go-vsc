...
The signer will generate a new private key, encrypts it according to [web3 keystore spec](https://github.com/vsportchain/wiki/wiki/Web3-Secret-Storage-Definition) and stores it in the keystore directory.
