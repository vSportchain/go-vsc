...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gvsc.ipc",
			endpoint:    "/data/testnet/gvsc.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gvsc.ipc",
			endpoint:    "/data/testnet/gvsc.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gvsc.ipc",
			endpoint:    "/data/testnet/gvsc.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gvsc.ipc",
			endpoint:    "/data/testnet/gvsc.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
