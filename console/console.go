...
import (
	...
	"github.com/vsportchain/go-vsc/internal/jsre"
	"github.com/vsportchain/go-vsc/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute VSportChain requests through
...
// Welcome show summary of current Gvsc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gvsc metadata
	fmt.Fprintf(c.printer, "Welcome to the Gvsc JavaScript console!\n\n")
	c.jsre.Run(`
