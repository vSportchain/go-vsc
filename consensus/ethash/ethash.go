...
// all blocks' seal as valid, though they still have to conform to the VSportChain
// consensus rules.
...
// still have to conform to the VSportChain consensus rules.
...
// they still have to conform to the VSportChain consensus rules.
