...
import (
	...
	"github.com/vsportchain/go-vsc/crypto/sha3"
...
// ecrecover extracts the VSportChain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the VSportChain address
...
// VSportChain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // VSportChain address of the signing key
...
// Author implements consensus.Engine, returning the VSportChain address recovered
