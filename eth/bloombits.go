...
import (
	...
	"github.com/vsportchain/go-vsc/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an VSportChain
...
func (eth *VSportChain) startBloomHandlers() {
...
// for the VSportChain header bloom filters, permitting blazing fast filtering.
