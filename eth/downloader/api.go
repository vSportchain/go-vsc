...
// Syncing provides information when this nodes starts synchronising with the VSportChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  vsportchain.SyncProgress `json:"status"`
}
