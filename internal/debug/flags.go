...
import (
	...
	"github.com/vsportchain/go-vsc/log/term"
	"github.com/vsportchain/go-vsc/metrics"
	"github.com/vsportchain/go-vsc/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. vsc/*=5,p2p=4)",
		Value: "",
	}
