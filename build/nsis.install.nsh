Name "gvsc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/vsportchain/go-vsc/issues"
!define UPDATEURL "https://github.com/vsportchain/go-vsc/releases"
!define ABOUTURL "https://github.com/vsportchain/go-vsc#vsportchain-go"
...
# Install gvsc binary
Section "Gvsc" GVSC_IDX
  SetOutPath $INSTDIR
  file {{.Gvsc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gvsc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gvsc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gvsc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gvsc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gvsc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gvsc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gvsc.exe" "" "" "VSportChain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gvsc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gvsc.exe" "" "" "VSportChain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gvsc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gvsc.exe" "" "" "VSportChain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/vsportchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "VSPORTCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\gvsc.ipc"
  ${EnvVarUpdate} $0 "VSPORTCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\gvsc.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GVSC_IDX}
    SectionGetSize ${GVSC_IDX} $0
