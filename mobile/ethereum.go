...
// Contains all the wrappers from the go-vsc root package.
...
// the VSportChain network.
type SyncProgress struct {
	progress vsportchain.SyncProgress
}
