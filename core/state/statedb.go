...
// Package state provides a caching layer atop the VSportChain state trie.
package state
...
// StateDBs within the vsportchain protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/vsportchain/go-vsc/pull/16485#issuecomment-380438527),
