...
// stateObject represents an VSportChain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of vsportchain address of the account
	data     Account
	db       *StateDB
...
// Account is the VSportChain consensus representation of accounts.
