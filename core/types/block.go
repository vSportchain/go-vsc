...
// Package types contains data types related to VSportChain consensus.
package types
...
// Header represents a block header in the VSportChain blockchain.
type Header struct {
...
// Block represents an entire block in the VSportChain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the VSportChain
...
// EncodeRLP serializes b into the VSportChain RLP block format.
