...
// Package chequebook package wraps the 'chequebook' VSportChain smart contract.
//
...
import (
	...
	"github.com/vsportchain/go-vsc/contracts/chequebook/contract"
	"github.com/vsportchain/go-vsc/core/types"
	"github.com/vsportchain/go-vsc/crypto"
	"github.com/vsportchain/go-vsc/log"
	"github.com/vsportchain/go-vsc/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an VSportChain transaction.
